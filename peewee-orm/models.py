...
# db = peewee.SqliteDatabase("restaurant.db")
...
# used for creating table Dish.ingrediets (ManyToManyField)
DishIngredient = Dish.ingredients.get_through_model()


# # DEZE WERKTE - AANGEPAST VOOR DISHINGREDIENTS
# def create_tables():
#     with db:
...
#                           Dish,
#                           Rating])
# # END DEZE WERKTE - AANGEPAST VOOR DISHINGREDIENTS
